  ...
  static async createJournalEntries(req, res, next) {
    try {
      ...
      if (check === false) {
        ...
        const updateProfit = await JournalEntryService.updateProfitProject(
          req.body,
          rev,
          exp
        );
        ...
        let updateAccount = await JournalEntryService.updateAccount(
          req.body,
          bal
        );
        ...
        let updateRecieverAccount =
          await JournalEntryService.updateReceiverAccount(req.body);
